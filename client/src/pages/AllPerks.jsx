...
export default function AllPerks() {
  ...
  // ✅ useEffect #1 — Load all perks initially (and when filters/search change)
  useEffect(() => {
    loadAllPerks()
  }, [searchQuery, merchantFilter])

  // ✅ useEffect #2 — Extract unique merchants whenever perks change
  useEffect(() => {
  ...
  function handleSearch(e) {
    e.preventDefault()
    loadAllPerks() // Manual search on Enter / button
  }
